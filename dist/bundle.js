...
function main() {
    ...
    ecg_device.ble.connect().then(function () {
        ...
        var container = new _Container__WEBPACK_IMPORTED_MODULE_5__.Container("#363537", "10px");
        //Create canvas
        var lead_I_canvas = new _SignalCanvas__WEBPACK_IMPORTED_MODULE_4__.SignalCanvas("I", false, "rgba(12,206,107,0.1)", "#0CCE6B", 0, 0, 1);
        var lead_II_canvas = new _SignalCanvas__WEBPACK_IMPORTED_MODULE_4__.SignalCanvas("II", false, "rgba(220,237,49,0.1)", "#DCED31", 0, 0, 1);
        var lead_III_canvas = new _SignalCanvas__WEBPACK_IMPORTED_MODULE_4__.SignalCanvas("III", false, "rgba(239,45,86,0.1)", "#EF2D56", 0, 0, 1);
        var lead_aVR_canvas = new _SignalCanvas__WEBPACK_IMPORTED_MODULE_4__.SignalCanvas("aVR", false, "rgba(237,125,58,0.1)", "#ED7D3A", 0, 0, 1);
        var lead_aVL_canvas = new _SignalCanvas__WEBPACK_IMPORTED_MODULE_4__.SignalCanvas("aVL", false, "rgba(202,12,206,0.1)", "#CA0CCE", 0, 0, 1);
        var lead_aVF_canvas = new _SignalCanvas__WEBPACK_IMPORTED_MODULE_4__.SignalCanvas("aVF", false, "rgba(72,145,255,0.1)", "#4891FF", 0, 0, 1);
        var lead_V1_canvas = new _SignalCanvas__WEBPACK_IMPORTED_MODULE_4__.SignalCanvas("V1", false, "rgba(255,205,107,0.1)", "#FFCD6B", 0, 0, 1);
        var lead_V2_canvas = new _SignalCanvas__WEBPACK_IMPORTED_MODULE_4__.SignalCanvas("V2", false, "rgba(255,112,215,0.1)", "#FF70D7", 0, 0, 1);
        var lead_V3_canvas = new _SignalCanvas__WEBPACK_IMPORTED_MODULE_4__.SignalCanvas("V3", false, "rgba(237,125,58,0.1)", "#ED7D3A", 0, 0, 1);
        var lead_V4_canvas = new _SignalCanvas__WEBPACK_IMPORTED_MODULE_4__.SignalCanvas("V4", false, "rgba(12,206,107,0.1)", "#0CCE6B", 0, 0, 1);
        var lead_V5_canvas = new _SignalCanvas__WEBPACK_IMPORTED_MODULE_4__.SignalCanvas("V5", false, "rgba(239,45,86,0.1)", "#EF2D56", 0, 0, 1);
        var lead_V6_canvas = new _SignalCanvas__WEBPACK_IMPORTED_MODULE_4__.SignalCanvas("V6", false, "rgba(202,12,206,0.1)", "#CA0CCE", 0, 0, 1);
