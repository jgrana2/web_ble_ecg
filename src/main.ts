...
function main() {
  ...
  ecg_device.ble.connect().then(() => {
    ...
    //Create canvas
    let lead_I_canvas       = new SignalCanvas("I", false, "rgba(12,206,107,0.1)", "#0CCE6B", 0, 0, 1);
    let lead_II_canvas      = new SignalCanvas("II", false, "rgba(220,237,49,0.1)", "#DCED31", 0, 0, 1);
    let lead_III_canvas     = new SignalCanvas("III", false, "rgba(239,45,86,0.1)", "#EF2D56", 0, 0, 1);
    let lead_aVR_canvas     = new SignalCanvas("aVR", false, "rgba(237,125,58,0.1)", "#ED7D3A", 0, 0, 1);
    let lead_aVL_canvas     = new SignalCanvas("aVL", false, "rgba(202,12,206,0.1)", "#CA0CCE", 0, 0, 1);
    let lead_aVF_canvas     = new SignalCanvas("aVF", false, "rgba(72,145,255,0.1)", "#4891FF", 0, 0, 1);
    let lead_V1_canvas      = new SignalCanvas("V1", false, "rgba(255,205,107,0.1)", "#FFCD6B", 0, 0, 1);
    let lead_V2_canvas      = new SignalCanvas("V2", false, "rgba(255,112,215,0.1)", "#FF70D7", 0, 0, 1);
    let lead_V3_canvas      = new SignalCanvas("V3", false, "rgba(237,125,58,0.1)", "#ED7D3A", 0, 0, 1);
    let lead_V4_canvas      = new SignalCanvas("V4", false, "rgba(12,206,107,0.1)", "#0CCE6B", 0, 0, 1);
    let lead_V5_canvas      = new SignalCanvas("V5", false, "rgba(239,45,86,0.1)", "#EF2D56", 0, 0, 1);
    let lead_V6_canvas      = new SignalCanvas("V6", false, "rgba(202,12,206,0.1)", "#CA0CCE", 0, 0, 1);
