...
var SignalCanvas = /** @class */ (function () {
    ...
    SignalCanvas.prototype.draw_line = function (data) {
        ...
        var i = 0;
        var parts = 4; // Has to be multiple of this.y_lpf.length = 28
        var loop = function () {
