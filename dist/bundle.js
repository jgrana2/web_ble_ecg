...
var BLEManager = /** @class */ (function () {
    ...
    BLEManager.prototype.start_notifications = function (characteristic, canvas) {
        var _this = this;
        this.server
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        gatt_characteristic_1.addEventListener("characteristicvaluechanged", function (event) { return _this.notification_handler(event, canvas, characteristic); });
    ...
    BLEManager.prototype.notification_handler = function (event, canvas, characteristic) {
        var data = this.convert_to_16bits(event.target.value);
        switch (canvas.id) {
            case "lead_III":
    ...
    BLEManager.prototype.convert_to_24_bits = function (view) {
        var is_negative;
        var value;
        var data_array_24_bits;
        data_array_24_bits = [];
        for (var index = 0; index < view.byteLength; index = index + Uint32Array.BYTES_PER_ELEMENT) {
    ...
    BLEManager.prototype.convert_to_16bits = function (view) {
        var data_array_16_bits = [];
        for (var index = 0; index < view.byteLength; index = index + Int16Array.BYTES_PER_ELEMENT) {
            data_array_16_bits.push(view.getInt16(index, true)); //Little endian
        }
        return data_array_16_bits;
    };
    BLEManager.prototype.disconnect = function () { };
    BLEManager.prototype.on_connect = function () { };
    BLEManager.prototype.on_disconnect = function () { };
    return BLEManager;
}());
...
var Container = /** @class */ (function () {
    ...
    Container.prototype.on_resize = function () {
        ...
        window.onresize = function () {
            _this.canvases.forEach(function (canvas) {
...
var Socket = /** @class */ (function () {
    function Socket() {
        this.client = socket_io_client__WEBPACK_IMPORTED_MODULE_0__.connect("http://144.202.5.9:9000");
...
function main() {
    ...
    ecg_device.ble.connect().then(function () {
        ...
        //Create canvas
        var lead_I_canvas = new _SignalCanvas__WEBPACK_IMPORTED_MODULE_4__.SignalCanvas("lead_I", false, "rgba(12,206,107,0.1)", "#0CCE6B", 0, 0, 1);
        var lead_II_canvas = new _SignalCanvas__WEBPACK_IMPORTED_MODULE_4__.SignalCanvas("lead_II", false, "rgba(220,237,49,0.1)", "#DCED31", 0, 0, 1);
        var lead_III_canvas = new _SignalCanvas__WEBPACK_IMPORTED_MODULE_4__.SignalCanvas("lead_III", false, "rgba(239,45,86,0.1)", "#EF2D56", 0, 0, 1);
        var lead_aVR_canvas = new _SignalCanvas__WEBPACK_IMPORTED_MODULE_4__.SignalCanvas("lead_aVR", false, "rgba(237,125,58,0.1)", "#ED7D3A", 0, 0, 1);
        var lead_aVL_canvas = new _SignalCanvas__WEBPACK_IMPORTED_MODULE_4__.SignalCanvas("lead_aVL", false, "rgba(202,12,206,0.1)", "#CA0CCE", 0, 0, 1);
        var lead_aVF_canvas = new _SignalCanvas__WEBPACK_IMPORTED_MODULE_4__.SignalCanvas("lead_aVF", false, "rgba(72,145,255,0.1)", "#4891FF", 0, 0, 1);
        var lead_V1_canvas = new _SignalCanvas__WEBPACK_IMPORTED_MODULE_4__.SignalCanvas("lead_V1", false, "rgba(255,205,107,0.1)", "#FFCD6B", 0, 0, 1);
        var lead_V2_canvas = new _SignalCanvas__WEBPACK_IMPORTED_MODULE_4__.SignalCanvas("lead_V2", false, "rgba(255,112,215,0.1)", "#FF70D7", 0, 0, 1);
        var lead_V3_canvas = new _SignalCanvas__WEBPACK_IMPORTED_MODULE_4__.SignalCanvas("lead_V3", false, "rgba(237,125,58,0.1)", "#ED7D3A", 0, 0, 1);
        var lead_V4_canvas = new _SignalCanvas__WEBPACK_IMPORTED_MODULE_4__.SignalCanvas("lead_V4", false, "rgba(12,206,107,0.1)", "#0CCE6B", 0, 0, 1);
        var lead_V5_canvas = new _SignalCanvas__WEBPACK_IMPORTED_MODULE_4__.SignalCanvas("lead_V5", false, "rgba(239,45,86,0.1)", "#EF2D56", 0, 0, 1);
        var lead_V6_canvas = new _SignalCanvas__WEBPACK_IMPORTED_MODULE_4__.SignalCanvas("lead_V6", false, "rgba(202,12,206,0.1)", "#CA0CCE", 0, 0, 1);
        var lead_II_canvas_big = new _SignalCanvas__WEBPACK_IMPORTED_MODULE_4__.SignalCanvas("lead_II_big", true, "rgba(12,206,107,0.1)", "#0CCE6B", 0, 0, 1);
